...
[← Previous lesson](../day_090_project__synthetic_breach_investigation/day_090_project__synthetic_breach_investigation.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_092_asset_inventory/day_092_asset_inventory.md)
...
1. Run the starter for **Day 91: Rules of Engagement** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 90](../day_090_project__synthetic_breach_investigation/day_090_project__synthetic_breach_investigation.md) · [Day index](../DAY_INDEX.md) · [Day 92 →](../day_092_asset_inventory/day_092_asset_inventory.md)
