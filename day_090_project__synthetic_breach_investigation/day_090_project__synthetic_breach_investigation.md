...
[← Previous lesson](../day_089_incident_reporting/day_089_incident_reporting.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_091_rules_of_engagement/day_091_rules_of_engagement.md)
...
1. Run the starter for **Day 90: Project: Synthetic Breach Investigation** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 89](../day_089_incident_reporting/day_089_incident_reporting.md) · [Day index](../DAY_INDEX.md) · [Day 91 →](../day_091_rules_of_engagement/day_091_rules_of_engagement.md)
