...
[Previous](../107_day_cloud_identity_concepts/107_day_cloud_identity_concepts.md) | [Next](../109_day_security_metrics/109_day_security_metrics.md)
...
Security engineering requires reliable decisions under imperfect input and failure. This day introduces **Configuration drift** through a bounded local fixture before asking you to generalize the pattern.
