...
[← Previous lesson](../day_041_addresses__ports__and_sockets/day_041_addresses__ports__and_sockets.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_043_udp_and_framing/day_043_udp_and_framing.md)
...
1. Run the starter for **Day 42: TCP Clients, Servers, and Framing** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 41](../day_041_addresses__ports__and_sockets/day_041_addresses__ports__and_sockets.md) · [Day index](../DAY_INDEX.md) · [Day 43 →](../day_043_udp_and_framing/day_043_udp_and_framing.md)
