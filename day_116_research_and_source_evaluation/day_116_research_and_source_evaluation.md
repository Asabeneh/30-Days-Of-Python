...
[← Previous lesson](../day_115_privacy_and_retention/day_115_privacy_and_retention.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_117_capstone_planning/day_117_capstone_planning.md)
...
1. Run the starter for **Day 116: Research and Source Evaluation** unchanged. What does it print, return, or create? Record the command and observed result.
