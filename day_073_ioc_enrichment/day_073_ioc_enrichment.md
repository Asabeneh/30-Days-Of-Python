...
[← Previous lesson](../day_072_log_normalization/day_072_log_normalization.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_074_detection_thresholds/day_074_detection_thresholds.md)
...
1. Run the starter for **Day 73: IOC Enrichment and Provenance** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 72](../day_072_log_normalization/day_072_log_normalization.md) · [Day index](../DAY_INDEX.md) · [Day 74 →](../day_074_detection_thresholds/day_074_detection_thresholds.md)
