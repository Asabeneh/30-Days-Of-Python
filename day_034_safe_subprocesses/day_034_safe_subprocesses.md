...
[← Previous lesson](../day_033_paths_and_file_metadata/day_033_paths_and_file_metadata.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_035_users_and_permissions/day_035_users_and_permissions.md)
...
1. Run the starter for **Day 34: Safe Subprocess Allowlisting** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 33](../day_033_paths_and_file_metadata/day_033_paths_and_file_metadata.md) · [Day index](../DAY_INDEX.md) · [Day 35 →](../day_035_users_and_permissions/day_035_users_and_permissions.md)
