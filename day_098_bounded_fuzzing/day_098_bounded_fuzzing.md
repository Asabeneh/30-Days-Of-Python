...
[← Previous lesson](../day_097_input_validation_testing/day_097_input_validation_testing.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_099_findings_and_retesting/day_099_findings_and_retesting.md)
...
1. Run the starter for **Day 98: Bounded Fuzzing** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 97](../day_097_input_validation_testing/day_097_input_validation_testing.md) · [Day index](../DAY_INDEX.md) · [Day 99 →](../day_099_findings_and_retesting/day_099_findings_and_retesting.md)
