...
[← Previous lesson](../day_093_safe_service_discovery/day_093_safe_service_discovery.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_095_local_web_testing/day_095_local_web_testing.md)
...
- [Topics](#topics)
  - [What is CVE and Severity Reasoning?](#what-is-cve-and-severity-reasoning)
  - [Why is CVE and Severity Reasoning useful?](#why-is-cve-and-severity-reasoning-useful)
  - [How will Python use this idea?](#how-will-python-use-this-idea)
  - [What are the security limits?](#what-are-the-security-limits)
- [Worked examples](#worked-examples)
  - [Example 1: Model a record](#example-1-model-a-record)
  - [Example 2: Separate severity and exposure](#example-2-separate-severity-and-exposure)
  - [Example 3: Check applicability](#example-3-check-applicability)
  - [Example 4: Record control](#example-4-record-control)
  - [Example 5: Choose action](#example-5-choose-action)
...
### What is CVE and Severity Reasoning?

A vulnerability identifier and a severity score are evidence inputs, not automatic remediation decisions. Engineers need affected version, exposure, exploitability, impact, and compensating controls.

### Why is CVE and Severity Reasoning useful?
...
The first runnable example introduces **CVE and Severity Reasoning**. Copy it into a new file and run it before changing anything. Then use this table to read the same code slowly. A line-by-line explanation does not replace practice: it shows you what to look for when a program behaves differently from your prediction.

| Line | Code | What Python is doing |
| ---: | --- | --- |
| 1 | `vuln = {"id": "CVE-training", "component": "training-lib", "version": "1.0"}` | Assignment: Python evaluates the right side and stores the result under the name on the left. |
| 2 | `print(vuln)` | Output call: Python evaluates the argument and writes a representation to the terminal. |
...
1. Run the starter for **Day 94: CVE and Severity Reasoning** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 93](../day_093_safe_service_discovery/day_093_safe_service_discovery.md) · [Day index](../DAY_INDEX.md) · [Day 95 →](../day_095_local_web_testing/day_095_local_web_testing.md)
