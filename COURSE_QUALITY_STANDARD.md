...
8. A numbered exercise section inside the lesson with direct questions or coding tasks, expected outputs, edge cases, and a challenge when appropriate. Each task must name the starting point and expected result.
9. Separate substantive `practice/hints.md` and `practice/solutions.md` files with numbered entries that follow the lesson exercises; the reading flow must not reveal full answers or collapse into a generic paragraph.
