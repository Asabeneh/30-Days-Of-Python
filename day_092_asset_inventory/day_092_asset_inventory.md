...
[← Previous lesson](../day_091_rules_of_engagement/day_091_rules_of_engagement.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_093_safe_service_discovery/day_093_safe_service_discovery.md)
...
1. Run the starter for **Day 92: Asset Inventory for Authorized Testing** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 91](../day_091_rules_of_engagement/day_091_rules_of_engagement.md) · [Day index](../DAY_INDEX.md) · [Day 93 →](../day_093_safe_service_discovery/day_093_safe_service_discovery.md)
