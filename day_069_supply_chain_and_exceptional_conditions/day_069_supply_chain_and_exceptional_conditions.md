...
[← Previous lesson](../day_068_misconfiguration_and_defaults/day_068_misconfiguration_and_defaults.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_070_project__secure_case_api/day_070_project__secure_case_api.md)
...
1. Run the starter for **Day 69: Supply Chain and Exceptional Conditions** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 68](../day_068_misconfiguration_and_defaults/day_068_misconfiguration_and_defaults.md) · [Day index](../DAY_INDEX.md) · [Day 70 →](../day_070_project__secure_case_api/day_070_project__secure_case_api.md)
