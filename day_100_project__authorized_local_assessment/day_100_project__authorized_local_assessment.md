...
[← Previous lesson](../day_099_findings_and_retesting/day_099_findings_and_retesting.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_101_secure_sdlc/day_101_secure_sdlc.md)
...
1. Run the starter for **Day 100: Project: Authorized Local Assessment** unchanged. What does it print, return, or create? Record the command and observed result.
