...
[← Previous lesson](../day_110_project__secure_delivery_pipeline/day_110_project__secure_delivery_pipeline.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_112_performance_and_backpressure/day_112_performance_and_backpressure.md)
...
1. Run the starter for **Day 111: Security Tool Architecture** unchanged. What does it print, return, or create? Record the command and observed result.
