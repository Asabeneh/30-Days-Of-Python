...
| 20 |  [Пакетный меджер Python](./20_Day_Python_package_manager/20_python_package_manager.md)|
...
| 25 |  [Библиотека Pandas](./25_Day_Pandas/25_pandas.md)|
...
| 30 |  [Выводы](./30_Day_Conclusions/30_conclusions.md)|
