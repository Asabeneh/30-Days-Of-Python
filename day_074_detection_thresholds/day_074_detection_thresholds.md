...
[← Previous lesson](../day_073_ioc_enrichment/day_073_ioc_enrichment.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_075_mitre_att_ck_mapping/day_075_mitre_att_ck_mapping.md)
...
1. Run the starter for **Day 74: Detection Thresholds and Evaluation** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 73](../day_073_ioc_enrichment/day_073_ioc_enrichment.md) · [Day index](../DAY_INDEX.md) · [Day 75 →](../day_075_mitre_att_ck_mapping/day_075_mitre_att_ck_mapping.md)
