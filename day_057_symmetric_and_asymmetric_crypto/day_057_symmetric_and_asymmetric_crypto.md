...
[← Previous lesson](../day_056_password_verification/day_056_password_verification.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_058_safe_serialization/day_058_safe_serialization.md)
...
1. Run the starter for **Day 57: Symmetric and Asymmetric Cryptography** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 56](../day_056_password_verification/day_056_password_verification.md) · [Day index](../DAY_INDEX.md) · [Day 58 →](../day_058_safe_serialization/day_058_safe_serialization.md)
