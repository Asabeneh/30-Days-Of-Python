...
[← Previous lesson](../day_045_http_requests_and_responses/day_045_http_requests_and_responses.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_047_packet_capture_fixtures/day_047_packet_capture_fixtures.md)
...
1. Run the starter for **Day 46: TLS and Certificate Validation** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 45](../day_045_http_requests_and_responses/day_045_http_requests_and_responses.md) · [Day index](../DAY_INDEX.md) · [Day 47 →](../day_047_packet_capture_fixtures/day_047_packet_capture_fixtures.md)
