...
[← Previous lesson](../day_018_classes_and_dataclasses/day_018_classes_and_dataclasses.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_020_project__log_triage_cli/day_020_project__log_triage_cli.md)
...
- [Worked examples](#worked-examples)
  ...
  - [Example 3: Assert rejection](#example-3-assert-rejection)
  - [Example 4: Use a temporary path](#example-4-use-a-temporary-path)
  - [Example 5: Test no secret leakage](#example-5-test-no-secret-leakage)
...
The first runnable example introduces **Testing Security Utilities**. Copy it into a new file and run it before changing anything. Then use this table to read the same code slowly. A line-by-line explanation does not replace practice: it shows you what to look for when a program behaves differently from your prediction.

| Line | Code | What Python is doing |
| ---: | --- | --- |
| 1 | `def test_severity_label_high():` | Function definition: Python records a reusable block with this name. |
| 2 | `result = severity_label(8)` | Assignment: Python evaluates the right side and stores the result under the name on the left. |
| 3 | `assert result == "high"` | Expression or data declaration: read the names, values, and operators and predict the result. |
...
[← Day 18](../day_018_classes_and_dataclasses/day_018_classes_and_dataclasses.md) · [Day index](../DAY_INDEX.md) · [Day 20 →](../day_020_project__log_triage_cli/day_020_project__log_triage_cli.md)
