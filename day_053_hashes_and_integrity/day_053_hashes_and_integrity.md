...
[← Previous lesson](../day_052_encoding_and_unicode/day_052_encoding_and_unicode.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_054_hmac_and_authenticity/day_054_hmac_and_authenticity.md)
...
1. Run the starter for **Day 53: Hashes and Integrity** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 52](../day_052_encoding_and_unicode/day_052_encoding_and_unicode.md) · [Day index](../DAY_INDEX.md) · [Day 54 →](../day_054_hmac_and_authenticity/day_054_hmac_and_authenticity.md)
