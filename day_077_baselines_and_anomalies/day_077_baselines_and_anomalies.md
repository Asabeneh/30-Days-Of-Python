...
[← Previous lesson](../day_076_alert_triage/day_076_alert_triage.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_078_threat_intelligence_provenance/day_078_threat_intelligence_provenance.md)
...
1. Run the starter for **Day 77: Baselines and Anomaly Reasoning** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 76](../day_076_alert_triage/day_076_alert_triage.md) · [Day index](../DAY_INDEX.md) · [Day 78 →](../day_078_threat_intelligence_provenance/day_078_threat_intelligence_provenance.md)
