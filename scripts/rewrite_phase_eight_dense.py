...
def render(spec: Spec) -> str:
    ...
    lines += [
        ...
        "## Exercises",
        "",
        "Complete the numbered questions in the numbered exercises in this lesson in order. Record the evidence, output, edge case, and limitation requested by each question.",
        "",
        "## Finish line",
        "",
