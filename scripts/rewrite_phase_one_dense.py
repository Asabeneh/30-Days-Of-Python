...
DAY_DIRS = {
    1: "day_01_setup_and_safe_practice",
    2: "day_02_values_names_and_input",
    3: "day_03_types_and_parsing",
    4: "day_04_operators_and_decisions",
    5: "day_05_branching_and_triage",
    6: "day_06_loops_and_bounded_work",
    7: "day_07_collections_and_iocs",
    8: "day_08_strings_and_canonicalization",
    9: "day_09_functions_and_validation",
...
NAV = {
    1: (
        ...
        "../README.md",
        "Day 2",
        "../day_02_values_names_and_input/day_02_values_names_and_input.md",
    ),
    2: (
        "Day 1",
        "../day_01_setup_and_safe_practice/day_01_setup_and_safe_practice.md",
        "Day 3",
        "../day_03_types_and_parsing/day_03_types_and_parsing.md",
    ),
    3: (
        "Day 2",
        "../day_02_values_names_and_input/day_02_values_names_and_input.md",
        "Day 4",
        "../day_04_operators_and_decisions/day_04_operators_and_decisions.md",
    ),
    4: (
        "Day 3",
        "../day_03_types_and_parsing/day_03_types_and_parsing.md",
        "Day 5",
        "../day_05_branching_and_triage/day_05_branching_and_triage.md",
    ),
    5: (
        "Day 4",
        "../day_04_operators_and_decisions/day_04_operators_and_decisions.md",
        "Day 6",
        "../day_06_loops_and_bounded_work/day_06_loops_and_bounded_work.md",
    ),
    6: (
        "Day 5",
        "../day_05_branching_and_triage/day_05_branching_and_triage.md",
        "Day 7",
        "../day_07_collections_and_iocs/day_07_collections_and_iocs.md",
    ),
    7: (
        "Day 6",
        "../day_06_loops_and_bounded_work/day_06_loops_and_bounded_work.md",
        "Day 8",
        "../day_08_strings_and_canonicalization/day_08_strings_and_canonicalization.md",
    ),
    8: (
        "Day 7",
        "../day_07_collections_and_iocs/day_07_collections_and_iocs.md",
        "Day 9",
        "../day_09_functions_and_validation/day_09_functions_and_validation.md",
    ),
    9: (
        "Day 8",
        "../day_08_strings_and_canonicalization/day_08_strings_and_canonicalization.md",
