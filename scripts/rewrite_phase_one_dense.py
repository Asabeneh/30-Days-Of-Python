...
NAV = {
    1: (
        ...
        "../README.md",
        "Day 2",
        "../day_002_values_names_and_input/day_002_values_names_and_input.md",
    ),
    2: (
        "Day 1",
        "../day_001_setup_and_safe_practice/day_001_setup_and_safe_practice.md",
        "Day 3",
        "../day_003_types_and_parsing/day_003_types_and_parsing.md",
    ),
    3: (
        "Day 2",
        "../day_002_values_names_and_input/day_002_values_names_and_input.md",
        "Day 4",
        "../day_004_operators_and_decisions/day_004_operators_and_decisions.md",
    ),
    4: (
        "Day 3",
        "../day_003_types_and_parsing/day_003_types_and_parsing.md",
        "Day 5",
        "../day_005_branching_and_triage/day_005_branching_and_triage.md",
    ),
    5: (
        "Day 4",
        "../day_004_operators_and_decisions/day_004_operators_and_decisions.md",
        "Day 6",
        "../day_006_loops_and_bounded_work/day_006_loops_and_bounded_work.md",
    ),
    6: (
        "Day 5",
        "../day_005_branching_and_triage/day_005_branching_and_triage.md",
        "Day 7",
        "../day_007_collections_and_iocs/day_007_collections_and_iocs.md",
    ),
    7: (
        "Day 6",
        "../day_006_loops_and_bounded_work/day_006_loops_and_bounded_work.md",
        "Day 8",
        "../day_008_strings_and_canonicalization/day_008_strings_and_canonicalization.md",
    ),
    8: (
        "Day 7",
        "../day_007_collections_and_iocs/day_007_collections_and_iocs.md",
        "Day 9",
        "../day_009_functions_and_validation/day_009_functions_and_validation.md",
    ),
    9: (
        "Day 8",
        "../day_008_strings_and_canonicalization/day_008_strings_and_canonicalization.md",
        "Day 10",
        "../day_010_checkpoint_log_triage/day_010_checkpoint_log_triage.md",
    ),
    10: (
        "Day 9",
        "../day_009_functions_and_validation/day_009_functions_and_validation.md",
        "Day 11",
        "../day_011_function_contracts/day_011_function_contracts.md",
    ),
}
