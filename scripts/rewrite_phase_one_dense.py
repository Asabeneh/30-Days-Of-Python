...
DAY_DIRS = {
    1: "001_day_setup_and_safe_practice",
    2: "002_day_values_names_and_input",
    3: "003_day_types_and_parsing",
    4: "004_day_operators_and_decisions",
    5: "005_day_branching_and_triage",
    6: "006_day_loops_and_bounded_work",
    7: "007_day_collections_and_iocs",
    8: "008_day_strings_and_canonicalization",
    9: "009_day_functions_and_validation",
...
NAV = {
    1: (
        ...
        "../README.md",
        "Day 2",
        "../002_day_values_names_and_input/002_day_values_names_and_input.md",
    ),
    2: (
        "Day 1",
        "../001_day_setup_and_safe_practice/001_day_setup_and_safe_practice.md",
        "Day 3",
        "../003_day_types_and_parsing/003_day_types_and_parsing.md",
    ),
    3: (
        "Day 2",
        "../002_day_values_names_and_input/002_day_values_names_and_input.md",
        "Day 4",
        "../004_day_operators_and_decisions/004_day_operators_and_decisions.md",
    ),
    4: (
        "Day 3",
        "../003_day_types_and_parsing/003_day_types_and_parsing.md",
        "Day 5",
        "../005_day_branching_and_triage/005_day_branching_and_triage.md",
    ),
    5: (
        "Day 4",
        "../004_day_operators_and_decisions/004_day_operators_and_decisions.md",
        "Day 6",
        "../006_day_loops_and_bounded_work/006_day_loops_and_bounded_work.md",
    ),
    6: (
        "Day 5",
        "../005_day_branching_and_triage/005_day_branching_and_triage.md",
        "Day 7",
        "../007_day_collections_and_iocs/007_day_collections_and_iocs.md",
    ),
    7: (
        "Day 6",
        "../006_day_loops_and_bounded_work/006_day_loops_and_bounded_work.md",
        "Day 8",
        "../008_day_strings_and_canonicalization/008_day_strings_and_canonicalization.md",
    ),
    8: (
        "Day 7",
        "../007_day_collections_and_iocs/007_day_collections_and_iocs.md",
        "Day 9",
        "../009_day_functions_and_validation/009_day_functions_and_validation.md",
    ),
    9: (
        "Day 8",
        "../008_day_strings_and_canonicalization/008_day_strings_and_canonicalization.md",
        "Day 10",
        "../010_day_checkpoint_log_triage/010_day_checkpoint_log_triage.md",
    ),
    10: (
        "Day 9",
        "../009_day_functions_and_validation/009_day_functions_and_validation.md",
        "Day 11",
        "../011_day_function_contracts/011_day_function_contracts.md",
    ),
}
