...
DIRS = {
    60: "day_060_project__tamper_evident_case_bundle",
    61: "day_061_local_service_architecture",
    62: "day_062_request_parsing_and_validation",
    63: "day_063_authentication_and_authorization",
    64: "day_064_injection_and_parameterized_queries",
    65: "day_065_xss_and_output_encoding",
    66: "day_066_csrf__cookies__and_cors",
    67: "day_067_ssrf_and_outbound_controls",
    68: "day_068_misconfiguration_and_defaults",
    69: "day_069_supply_chain_and_exceptional_conditions",
    70: "day_070_project__secure_case_api",
    71: "day_071_telemetry_and_event_schemas",
    72: "day_072_log_normalization",
    73: "day_073_ioc_enrichment",
    74: "day_074_detection_thresholds",
    75: "day_075_mitre_att_ck_mapping",
    76: "day_076_alert_triage",
    77: "day_077_baselines_and_anomalies",
    78: "day_078_threat_intelligence_provenance",
    79: "day_079_analyst_reporting",
    80: "day_080_project__mini_detection_pipeline",
    81: "day_081_response_lifecycle",
}
...
def render(spec: Spec) -> str:
    ...
    lines += [
        ...
        "## Exercises",
        "",
        "Complete the numbered questions in the numbered exercises in this lesson in order. Use the examples as a starting point, then record the requested output, edge case, and limitation.",
        "",
        "## Finish line",
        "",
