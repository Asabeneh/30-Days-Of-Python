...
[← Previous lesson](../day_050_project__local_service_monitor/day_050_project__local_service_monitor.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_052_encoding_and_unicode/day_052_encoding_and_unicode.md)
...
1. Run the starter for **Day 51: Trust Boundaries and Threat Models for Crypto** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 50](../day_050_project__local_service_monitor/day_050_project__local_service_monitor.md) · [Day index](../DAY_INDEX.md) · [Day 52 →](../day_052_encoding_and_unicode/day_052_encoding_and_unicode.md)
