...
[← Previous lesson](../day_077_baselines_and_anomalies/day_077_baselines_and_anomalies.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_079_analyst_reporting/day_079_analyst_reporting.md)
...
- [Worked examples](#worked-examples)
  ...
  - [Example 3: Track transformation](#example-3-track-transformation)
  - [Example 4: Apply freshness](#example-4-apply-freshness)
  - [Example 5: Respect handling](#example-5-respect-handling)
...
| ---: | --- | --- |
| 1 | `report = {` | Assignment: Python evaluates the right side and stores the result under the name on the left. |
| 2 | `"source": "training-lab",` | Expression or data declaration: read the names, values, and operators and predict the result. |
| 3 | `"observed_at": "2026-08-20",` | Expression or data declaration: read the names, values, and operators and predict the result. |
| 4 | `"indicator": "example.invalid",` | Expression or data declaration: read the names, values, and operators and predict the result. |
| 5 | `}` | Expression or data declaration: read the names, values, and operators and predict the result. |
| 6 | `print(report)` | Output call: Python evaluates the argument and writes a representation to the terminal. |
...
1. Run the starter for **Day 78: Threat Intelligence Provenance** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 77](../day_077_baselines_and_anomalies/day_077_baselines_and_anomalies.md) · [Day index](../DAY_INDEX.md) · [Day 79 →](../day_079_analyst_reporting/day_079_analyst_reporting.md)
