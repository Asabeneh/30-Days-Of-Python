...
[← Previous lesson](../day_082_evidence_integrity/day_082_evidence_integrity.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_084_sqlite_artifacts/day_084_sqlite_artifacts.md)
...
- [Worked examples](#worked-examples)
  ...
  - [Example 3: Record source](#example-3-record-source)
  - [Example 4: Flag clock uncertainty](#example-4-flag-clock-uncertainty)
  - [Example 5: Identify a gap](#example-5-identify-a-gap)
...
The first runnable example introduces **Filesystem Timelines**. Copy it into a new file and run it before changing anything. Then use this table to read the same code slowly. A line-by-line explanation does not replace practice: it shows you what to look for when a program behaves differently from your prediction.

| Line | Code | What Python is doing |
| ---: | --- | --- |
| 1 | `events = [{"path": "a.txt", "kind": "modified", "time": "10:00Z"}]` | Assignment: Python evaluates the right side and stores the result under the name on the left. |
| 2 | `print(events)` | Output call: Python evaluates the argument and writes a representation to the terminal. |
...
1. Run the starter for **Day 83: Filesystem Timelines** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 82](../day_082_evidence_integrity/day_082_evidence_integrity.md) · [Day index](../DAY_INDEX.md) · [Day 84 →](../day_084_sqlite_artifacts/day_084_sqlite_artifacts.md)
