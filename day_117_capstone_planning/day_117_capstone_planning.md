...
[← Previous lesson](../day_116_research_and_source_evaluation/day_116_research_and_source_evaluation.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_118_capstone_implementation/day_118_capstone_implementation.md)
...
1. Run the starter for **Day 117: Capstone Planning** unchanged. What does it print, return, or create? Record the command and observed result.
