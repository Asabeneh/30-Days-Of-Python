...
[← Day 64](../day_64_injection_and_parameterized_queries/day_64_injection_and_parameterized_queries.md) · [Day index](../DAY_INDEX.md) · [Day 66 →](../day_66_csrf__cookies__and_cors/day_66_csrf__cookies__and_cors.md)
...
Run `python -m course_days.day65`, pass the relevant tests, complete the numbered exercises, and explain one edge case aloud or in writing.
