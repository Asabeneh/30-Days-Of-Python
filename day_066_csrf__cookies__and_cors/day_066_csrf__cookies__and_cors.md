...
[← Previous lesson](../day_065_xss_and_output_encoding/day_065_xss_and_output_encoding.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_067_ssrf_and_outbound_controls/day_067_ssrf_and_outbound_controls.md)
...
1. Run the starter for **Day 66: CSRF, Cookies, and CORS** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 65](../day_065_xss_and_output_encoding/day_065_xss_and_output_encoding.md) · [Day index](../DAY_INDEX.md) · [Day 67 →](../day_067_ssrf_and_outbound_controls/day_067_ssrf_and_outbound_controls.md)
