...
[← Previous lesson](../day_087_network_evidence/day_087_network_evidence.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_089_incident_reporting/day_089_incident_reporting.md)
...
1. Run the starter for **Day 88: Volatile Evidence Concepts** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 87](../day_087_network_evidence/day_087_network_evidence.md) · [Day index](../DAY_INDEX.md) · [Day 89 →](../day_089_incident_reporting/day_089_incident_reporting.md)
