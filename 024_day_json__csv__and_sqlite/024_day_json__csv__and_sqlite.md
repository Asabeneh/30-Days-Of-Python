...
Security engineering requires reliable decisions under imperfect input and failure. This day introduces **JSON, CSV, and SQLite** through a bounded local fixture before asking you to generalize the pattern.
