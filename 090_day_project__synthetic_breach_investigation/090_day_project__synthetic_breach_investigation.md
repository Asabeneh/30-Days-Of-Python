...
[Previous](../089_day_incident_reporting/089_day_incident_reporting.md) | [Next](../091_day_rules_of_engagement/091_day_rules_of_engagement.md)
...
Security engineering requires reliable decisions under imperfect input and failure. This day introduces **Project: Synthetic Breach Investigation** through a bounded local fixture before asking you to generalize the pattern.
