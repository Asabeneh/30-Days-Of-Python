...
[← Previous lesson](../day_107_cloud_identity_concepts/day_107_cloud_identity_concepts.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_109_security_metrics/day_109_security_metrics.md)
...
1. Run the starter for **Day 108: Configuration Drift** unchanged. What does it print, return, or create? Record the command and observed result.
