...
[← Previous lesson](../day_058_safe_serialization/day_058_safe_serialization.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_060_project__tamper_evident_case_bundle/day_060_project__tamper_evident_case_bundle.md)
...
1. Run the starter for **Day 59: Secure Errors and Logging** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 58](../day_058_safe_serialization/day_058_safe_serialization.md) · [Day index](../DAY_INDEX.md) · [Day 60 →](../day_060_project__tamper_evident_case_bundle/day_060_project__tamper_evident_case_bundle.md)
