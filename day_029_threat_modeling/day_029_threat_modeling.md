...
[← Previous lesson](../day_028_dependency_hygiene_and_sboms/day_028_dependency_hygiene_and_sboms.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_030_project__secure_evidence_journal/day_030_project__secure_evidence_journal.md)
...
2. For the log-triage CLI, name one thing to protect, one danger, one check, and one remaining problem.
...
[← Day 28](../day_028_dependency_hygiene_and_sboms/day_028_dependency_hygiene_and_sboms.md) · [Day index](../DAY_INDEX.md) · [Day 30 →](../day_030_project__secure_evidence_journal/day_030_project__secure_evidence_journal.md)
