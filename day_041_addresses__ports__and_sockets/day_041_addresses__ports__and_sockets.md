...
[← Previous lesson](../day_040_project__host_baseline_auditor/day_040_project__host_baseline_auditor.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_042_tcp_clients_and_servers/day_042_tcp_clients_and_servers.md)
...
1. Run the starter for **Day 41: Addresses, Ports, and Sockets** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 40](../day_040_project__host_baseline_auditor/day_040_project__host_baseline_auditor.md) · [Day index](../DAY_INDEX.md) · [Day 42 →](../day_042_tcp_clients_and_servers/day_042_tcp_clients_and_servers.md)
