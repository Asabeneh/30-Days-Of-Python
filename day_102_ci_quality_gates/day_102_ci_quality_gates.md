...
[← Previous lesson](../day_101_secure_sdlc/day_101_secure_sdlc.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_103_static_analysis/day_103_static_analysis.md)
...
1. Run the starter for **Day 102: CI Quality Gates** unchanged. What does it print, return, or create? Record the command and observed result.
