...
[← Previous lesson](../day_025_type_hints_and_static_checks/day_025_type_hints_and_static_checks.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_027_git_and_code_review/day_027_git_and_code_review.md)
...
- [Topics](#topics)
  - [What is Structured Logging and Redaction?](#what-is-structured-logging-and-redaction)
  - [Why is Structured Logging and Redaction useful?](#why-is-structured-logging-and-redaction-useful)
...
### What is Structured Logging and Redaction?

Logs are evidence for operators and input for future tools. Unstructured messages are hard to query; unredacted messages can leak secrets.

### Why is Structured Logging and Redaction useful?
...
[← Day 25](../day_025_type_hints_and_static_checks/day_025_type_hints_and_static_checks.md) · [Day index](../DAY_INDEX.md) · [Day 27 →](../day_027_git_and_code_review/day_027_git_and_code_review.md)
