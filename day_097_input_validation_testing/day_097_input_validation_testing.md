...
[← Previous lesson](../day_096_authorization_testing/day_096_authorization_testing.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_098_bounded_fuzzing/day_098_bounded_fuzzing.md)
...
1. Run the starter for **Day 97: Input Validation Testing** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 96](../day_096_authorization_testing/day_096_authorization_testing.md) · [Day index](../DAY_INDEX.md) · [Day 98 →](../day_098_bounded_fuzzing/day_098_bounded_fuzzing.md)
