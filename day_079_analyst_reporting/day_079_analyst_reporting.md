...
[← Previous lesson](../day_078_threat_intelligence_provenance/day_078_threat_intelligence_provenance.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_080_project__mini_detection_pipeline/day_080_project__mini_detection_pipeline.md)
...
- [Topics](#topics)
  - [What is Analyst Reporting and Evidence-Based Writing?](#what-is-analyst-reporting-and-evidence-based-writing)
  - [Why is Analyst Reporting and Evidence-Based Writing useful?](#why-is-analyst-reporting-and-evidence-based-writing-useful)
  - [How will Python use this idea?](#how-will-python-use-this-idea)
  - [What are the security limits?](#what-are-the-security-limits)
- [Worked examples](#worked-examples)
  - [Example 1: Write an observation](#example-1-write-an-observation)
  - [Example 2: Write analysis](#example-2-write-analysis)
  - [Example 3: Write assessment](#example-3-write-assessment)
  - [Example 4: Name next step](#example-4-name-next-step)
  - [Example 5: List limitations](#example-5-list-limitations)
...
### What is Analyst Reporting and Evidence-Based Writing?

A security report must let another person reproduce the reasoning. Separating observation, analysis, assessment, action, and limitation reduces accidental overclaiming.

### Why is Analyst Reporting and Evidence-Based Writing useful?
...
The first runnable example introduces **Analyst Reporting and Evidence-Based Writing**. Copy it into a new file and run it before changing anything. Then use this table to read the same code slowly. A line-by-line explanation does not replace practice: it shows you what to look for when a program behaves differently from your prediction.

| Line | Code | What Python is doing |
| ---: | --- | --- |
| 1 | `observation = (` | Assignment: Python evaluates the right side and stores the result under the name on the left. |
| 2 | `"Three failed logins occurred in the training fixture between 10:00 and 10:02 UTC."` | Expression or data declaration: read the names, values, and operators and predict the result. |
| 3 | `)` | Expression or data declaration: read the names, values, and operators and predict the result. |
| 4 | `print(observation)` | Output call: Python evaluates the argument and writes a representation to the terminal. |
...
1. Run the starter for **Day 79: Analyst Reporting and Evidence-Based Writing** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 78](../day_078_threat_intelligence_provenance/day_078_threat_intelligence_provenance.md) · [Day index](../DAY_INDEX.md) · [Day 80 →](../day_080_project__mini_detection_pipeline/day_080_project__mini_detection_pipeline.md)
