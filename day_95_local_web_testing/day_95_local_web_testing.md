...
[← Day 94](../day_94_cve_and_severity_reasoning/day_94_cve_and_severity_reasoning.md) · [Day index](../DAY_INDEX.md) · [Day 96 →](../day_96_authorization_testing/day_96_authorization_testing.md)
...
Run `python -m course_days.day95`, pass the relevant tests, complete the numbered exercises, and explain one edge case aloud or in writing.
