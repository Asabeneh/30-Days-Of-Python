...
[← Previous lesson](../day_084_sqlite_artifacts/day_084_sqlite_artifacts.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_086_email_and_phishing_fixtures/day_086_email_and_phishing_fixtures.md)
...
1. Run the starter for **Day 85: Browser and Document Artifacts** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 84](../day_084_sqlite_artifacts/day_084_sqlite_artifacts.md) · [Day index](../DAY_INDEX.md) · [Day 86 →](../day_086_email_and_phishing_fixtures/day_086_email_and_phishing_fixtures.md)
