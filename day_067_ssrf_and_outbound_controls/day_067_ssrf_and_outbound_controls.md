...
[← Previous lesson](../day_066_csrf__cookies__and_cors/day_066_csrf__cookies__and_cors.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_068_misconfiguration_and_defaults/day_068_misconfiguration_and_defaults.md)
...
1. Run the starter for **Day 67: SSRF and Outbound Request Controls** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 66](../day_066_csrf__cookies__and_cors/day_066_csrf__cookies__and_cors.md) · [Day index](../DAY_INDEX.md) · [Day 68 →](../day_068_misconfiguration_and_defaults/day_068_misconfiguration_and_defaults.md)
