...
[← Previous lesson](../day_070_project__secure_case_api/day_070_project__secure_case_api.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_072_log_normalization/day_072_log_normalization.md)
...
1. Run the starter for **Day 71: Telemetry and Event Schemas** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 70](../day_070_project__secure_case_api/day_070_project__secure_case_api.md) · [Day index](../DAY_INDEX.md) · [Day 72 →](../day_072_log_normalization/day_072_log_normalization.md)
