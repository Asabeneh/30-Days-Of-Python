...
[← Previous lesson](../day_103_static_analysis/day_103_static_analysis.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_105_secret_detection/day_105_secret_detection.md)
...
1. Run the starter for **Day 104: SBOM and Provenance** unchanged. What does it print, return, or create? Record the command and observed result.
