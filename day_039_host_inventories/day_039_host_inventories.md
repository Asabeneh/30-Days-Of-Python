...
[← Previous lesson](../day_038_async_i_o/day_038_async_i_o.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_040_project__host_baseline_auditor/day_040_project__host_baseline_auditor.md)
...
1. Run the starter for **Day 39: Host Inventories and Baseline Data** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 38](../day_038_async_i_o/day_038_async_i_o.md) · [Day index](../DAY_INDEX.md) · [Day 40 →](../day_040_project__host_baseline_auditor/day_040_project__host_baseline_auditor.md)
