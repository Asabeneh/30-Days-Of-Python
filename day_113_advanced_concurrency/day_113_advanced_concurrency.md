...
[← Previous lesson](../day_112_performance_and_backpressure/day_112_performance_and_backpressure.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_114_failure_injection_and_recovery/day_114_failure_injection_and_recovery.md)
...
1. Run the starter for **Day 113: Advanced Concurrency and Cancellation** unchanged. What does it print, return, or create? Record the command and observed result.
