...
[← Previous lesson](../day_102_ci_quality_gates/day_102_ci_quality_gates.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_104_sbom_and_provenance/day_104_sbom_and_provenance.md)
...
1. Run the starter for **Day 103: Static Analysis and Code Review Signals** unchanged. What does it print, return, or create? Record the command and observed result.
