...
[← Previous lesson](../day_118_capstone_implementation/day_118_capstone_implementation.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_120_final_demonstration/day_120_final_demonstration.md)
...
1. Run the starter for **Day 119: Capstone Security Review** unchanged. What does it print, return, or create? Record the command and observed result.
