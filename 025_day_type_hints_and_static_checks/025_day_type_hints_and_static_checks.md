...
Security engineering requires reliable decisions under imperfect input and failure. This day introduces **Type hints and static checks** through a bounded local fixture before asking you to generalize the pattern.
