...
[← Previous lesson](../day_119_capstone_security_review/day_119_capstone_security_review.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Course index →](../DAY_INDEX.md)
...
- [Worked examples](#worked-examples)
  ...
  - [Example 3: Run a normal case](#example-3-run-a-normal-case)
  - [Example 4: Run a failure case](#example-4-run-a-failure-case)
  - [Example 5: Give the retrospective](#example-5-give-the-retrospective)
...
The first runnable example introduces **Final Demonstration and Engineering Judgment**. Copy it into a new file and run it before changing anything. Then use this table to read the same code slowly. A line-by-line explanation does not replace practice: it shows you what to look for when a program behaves differently from your prediction.

| Line | Code | What Python is doing |
| ---: | --- | --- |
| 1 | `setup = {"clone": True, "venv": True, "tests": "pass", "fixtures": "present"}` | Assignment: Python evaluates the right side and stores the result under the name on the left. |
| 2 | `print(setup)` | Output call: Python evaluates the argument and writes a representation to the terminal. |
...
1. Run the starter for **Day 120: Final Demonstration and Engineering Judgment** unchanged. What does it print, return, or create? Record the command and observed result.
