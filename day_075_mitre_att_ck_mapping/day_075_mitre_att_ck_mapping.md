...
1. Run the starter for **Day 75: MITRE ATT&CK Mapping as Documentation** unchanged. What does it print, return, or create? Record the command and observed result.
