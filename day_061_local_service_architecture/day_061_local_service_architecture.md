...
[← Previous lesson](../day_060_project__tamper_evident_case_bundle/day_060_project__tamper_evident_case_bundle.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_062_request_parsing_and_validation/day_062_request_parsing_and_validation.md)
...
- [Worked examples](#worked-examples)
  ...
  - [Example 3: Return a result](#example-3-return-a-result)
  - [Example 4: Name a trust boundary](#example-4-name-a-trust-boundary)
  - [Example 5: Keep local scope](#example-5-keep-local-scope)
...
| ---: | --- | --- |
| 1 | `stages = ["request", "parse", "validate", "authorize", "service", "response"]` | Assignment: Python evaluates the right side and stores the result under the name on the left. |
...
1. Run the starter for **Day 61: Local Service Architecture** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 60](../day_060_project__tamper_evident_case_bundle/day_060_project__tamper_evident_case_bundle.md) · [Day index](../DAY_INDEX.md) · [Day 62 →](../day_062_request_parsing_and_validation/day_062_request_parsing_and_validation.md)
