...
[← Previous lesson](../day_043_udp_and_framing/day_043_udp_and_framing.md) · [README](../README.md) · [Setup](../SETUP.md) · [VS Code](../VS_CODE_SETUP.md) · [Day index](../DAY_INDEX.md) · [Next lesson →](../day_045_http_requests_and_responses/day_045_http_requests_and_responses.md)
...
1. Run the starter for **Day 44: DNS Concepts and Safe Resolution** unchanged. What does it print, return, or create? Record the command and observed result.
...
[← Day 43](../day_043_udp_and_framing/day_043_udp_and_framing.md) · [Day index](../DAY_INDEX.md) · [Day 45 →](../day_045_http_requests_and_responses/day_045_http_requests_and_responses.md)
